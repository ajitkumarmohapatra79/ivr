...
#     print('batch len={}, batch 0={}'.format(len(batch), batch[0]))
#     print('batch 0 type={}'.format(type(batch[0])))
#     to_data_out = to_data(batch)
#     print('to_data={}'.format(to_data_out))
    collated = torch.utils.data.dataloader.default_collate(to_data(batch))
#     print('collated={}'.format(collated))
    return collated
