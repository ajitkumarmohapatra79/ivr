...
#     print('len xb=', len(xb))
#     print('xb=', xb)
#     print('xb0 shape={}'.format(xb[0].shape))
#     print('xb1 shape={}'.format(xb[1].shape))

#     b = 0
#     assert b != 0, "force an assertion to see who passed xb"
...
def fit(epochs:int, learn:BasicLearner, callbacks:Optional[CallbackList]=None, metrics:OptMetrics=None)->None:
    ...
    try:
        for epoch in pbar:
            ...
            learn.model.train()
#             print('learn.data.train_dl={}'.format(type(learn.data.train_dl)))
#             for i,dl in enumerate(learn.data.train_dl):
#                 print('dl={}'.format(dl))
#                 if i > 1:
#                     break
            cb_handler.set_dl(learn.data.train_dl)
#             print('learn.data.train_dl={}'.format(learn.data.train_dl))
            cb_handler.on_epoch_begin()
            i = 0
            for xb,yb in progress_bar(learn.data.train_dl, parent=pbar):
#                 print('one iteration {}'.format(i))
                i += 1
