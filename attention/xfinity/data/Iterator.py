"""
Need our own Iterator that works with a DataSet which is a simple Iterator of Tensors
User TensorDataset from torch.utils.data.dataset
"""
...
def batch(data, batch_size, batch_size_fn=None):
    ...
    for ex in data:     # data must be an iterator of tensors
        minibatch.append(ex)
