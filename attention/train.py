...
#     print('item src={}'.format(item.src))
    ...
    for batch in tqdm(training_data, mininterval=2, desc=desc, leave=False):
        ...
        # prepare data
        print('batch.src shape={}'.format(batch.src.shape))
...
#     field = data['vocab']['src']
#     print('type vocab={}'.format(type(field.vocab)))
#     print('type stoi={}'.format(type(field.vocab.stoi)))
#     print("data['vocab']['src']={}".format(data['vocab']['src']))

#     print("data['train'][0].src={}".format(data['train'][0].src))
    train = Dataset(examples=data['train'], fields=fields)
#     print('type train={}'.format(type(train)))
